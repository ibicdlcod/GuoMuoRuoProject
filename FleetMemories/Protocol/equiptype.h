...
#pragma message(USED_CXX17)
    ...
    inline static const QMap<QString, int> result = {
        ...
        std::pair("Attack-lb-fight-jet",    0x001C0720),
        ...
        std::pair("Sp-bomb-small",          0x0189),
        std::pair("Sp-bomb",                0x018A),
        std::pair("Sp-bomb-night",          0x019A),
    ...
    inline static const QHash<QString, int> groupToIcon = {
        ...
        std::pair("Attack-lb-fight-jet",    59),//震电改三=60
    ...
    inline static const QHash<QString, QString> primaryAttr = {
        ...
        std::pair("Attack-lb-fight-jet",    "Bombing"),
    ...
    inline static const QHash<QString, int> displaySort = {
        ...
        std::pair("Attack-lb-fight-jet",    24),
