...
bool SslServer::setSslLocalCertificate(const QString &path,
...
bool SslServer::setSslPrivateKey(const QString &fileName,
    ...
    m_sslPrivateKey = QSslKey(keyFile.readAll(), algorithm,
