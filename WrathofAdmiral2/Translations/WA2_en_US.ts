...
<context>
    ...
    <message id="port-invalid">
        <location filename="../Client/client.cpp" line="399"/>
    ...
    <message id="password-enter">
        <location filename="../Client/client.cpp" line="406"/>
    ...
    <message id="switch-usage">
        <location filename="../Client/client.cpp" line="299"/>
        <source>Usage: switch [gamestate]</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="game-unexpected-state">
        <location filename="../Client/client.cpp" line="310"/>
    ...
    <message id="register-failed">
        <location filename="../Client/client.cpp" line="642"/>
        <source>%1: register failure, reason: %2</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="login-success">
        <location filename="../Client/client.cpp" line="565"/>
        <source>%1: login success</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="password-incorrect">
        <location filename="../Client/client.cpp" line="572"/>
        <source></source>
        <translation type="unfinished"></translation>
    </message>
    <message id="login-failed">
        <location filename="../Client/client.cpp" line="576"/>
    ...
    <message id="client-bad-json">
        <location filename="../Client/client.cpp" line="607"/>
...
Great at battle and bad at politics--so cool!</source>
    ...
    <message id="invalid-command">
        <location filename="../Protocol/commandline.cpp" line="224"/>
    ...
    <message id="all-command">
        <location filename="../Protocol/commandline.cpp" line="240"/>
        <source>All commands:</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="help-msg">
        <location filename="../Protocol/commandline.cpp" line="210"/>
        <source>Use &apos;exit&apos; to quit, &apos;help&apos; to show help, &apos;commands&apos; to show available commands.</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="goodbye">
        <location filename="../Protocol/commandline.cpp" line="375"/>
    ...
    <message id="user-db-lack">
        <location filename="../Server/server.cpp" line="355"/>
    ...
    <message id="user-db-gen-failure">
        <location filename="../Server/server.cpp" line="373"/>
    ...
    <message id="user-db-bad">
        <location filename="../Server/server.cpp" line="401"/>
    ...
    <message id="read-peerinfo-failed">
        <location filename="../Server/server.cpp" line="619"/>
    ...
    <message id="equip-refresh-failed">
        ...
        <source>Load equipment database failed!</source>
        <translation type="unfinished"></translation>
    </message>
    ...
    <message id="equip-export-failed">
        <location filename="../Server/server.cpp" line="821"/>
        <source>Export equipment database failed!</source>
        <translation type="unfinished"></translation>
    </message>
    ...
    <message id="db-error">
        <location filename="../Server/kerrors.h" line="16"/>
