...
|         Field          |        Equipment meaning [Implemented in equipment.h]        |             Ship meaning [Implemented in ship.h]             |
| :--------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
...
|          DPM           |  Equivalent to 0.1 firepower in KC, countered by hitpoints.  | ditto (Carrier's DPM is special as it amplifies plane's airtorpedo/bombing) |
