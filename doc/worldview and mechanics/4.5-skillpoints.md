...
[Implemented Server::processExpGain#equip] Gain: equal to kanmusu that mounted this equipment, unless its "mother" is a real equipment, then it gain (1/tech) as many skill points in battle[NOTIMPLEMENTED] but can transfer skill points from its "mother equipment" at a ratio of (\sqrt{tech of "son equipment"} : 1)
...
[NOTYETIMPLEMENTED] At 0% stand skill points the equipment is 29.29% effective, at 100% points 100% effective. Maximum effectiveness (without improvement) is 129.29%. Therefore an inferior equipment with enough skill points may outperform a superior but unskilled one.
$$
